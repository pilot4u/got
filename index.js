...
function defaultPreStream(i){
	return i
}

function requestAsEventEmitter(opts) {
	opts = opts || {};
	if (!opts.preStream) opts.preStream= defaultPreStream;
...
function asPromise(opts) {
	return new Promise((resolve, reject) => {
		...
		ee.on('response', res => {
			const stream = opts.encoding === null ? getStream.buffer(opts.preStream(res)) : getStream(opts.preStream(res), opts);
